...
from gestion_agro.views import (ajax_agregar_producto_final, ajax_crear_producto_desde_cultivo, ajax_info_cultivo, ajax_areas_por_campo, ajax_unidades_por_base, ajax_variedades_cultivo, vista_crear_campo, ajax_eliminar_insumo, ajax_editar_insumo, vista_resumo_economico, ajax_eliminar_actividad,
